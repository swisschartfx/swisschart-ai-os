...
// Legacy/manual compatibility store only. The schema 4.5 scheduling
// foundation uses SqliteAutomationStore and explicitly disables this store.
class LegacyJsonAutomationStore {
    constructor(options = {}) {
...
module.exports = LegacyJsonAutomationStore;
